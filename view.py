...
class CalculatorView(QWidget):
    ...
    def initUI(self):
        ...
        buttons = [
            ('7', 1, 0, '#000066'), ('8', 1, 1, '#000066'), ('9', 1, 2, '#000066'), ('/', 1, 3, '#2196F3'),
            ('4', 2, 0, '#000066'), ('5', 2, 1, '#000066'), ('6', 2, 2, '#000066'), ('*', 2, 3, '#2196F3'),
            ('1', 3, 0, '#000066'), ('2', 3, 1, '#000066'), ('3', 3, 2, '#000066'), ('-', 3, 3, '#2196F3'),
            ('0', 4, 0, '#000066'), ('C', 4, 1, '#000066'), ('=', 4, 2, '#fff'), ('+', 4, 3, '#2196F3')
        ]
